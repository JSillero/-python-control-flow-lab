...
def determine_season():
    ...
    if (month == "Jan" or month == "Feb" or (month =="Dec" and day>=21 ) or (month =="Mar" and day<=19)) :
        season = "Winter"
    elif (month == "Apr" or month == "May" or (month =="Jun" and day<=20 ) or (month =="Mar" and day>=20)) :
        season = "Spring"
    elif (month == "Jul" or month == "Aug" or (month =="Jun" and day>=21 ) or (month =="Sep" and day<=21)) :
        season = "Summer"
    elif (month == "Oct" or month == "Nov" or (month =="Dec" and day<=20 ) or (month =="Sep" and day>=22)) :
        season = "Summer"
